...
<head>
    ...
    <title>Alterar Turma - Devant</title>
</head>
        ...
        <div class="max-w-7xl mx-auto px-0 py-3 flex items-center">
            ...
            <nav class="nav flex-1 flex justify-center mb-[-1%]">
                <ul class="flex gap-12 items-center">
                    <li>
                        <a href="${pageContext.request.contextPath}/adm/perfil-adm.jp" class="nav-link flex items-center gap-2 hover:opacity-80 text-[120%]">
                            Perfil
                        </a>
                    </li>
                    <li>
