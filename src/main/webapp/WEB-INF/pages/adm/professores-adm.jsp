...
<head>
    ...
    <title>Professores - Devant</title>
</head>
...
<body class="bg-[#EDEFEF]">
    ...
    <main class="flex-1 p-4">
        <section>
            <h1 class="text-[#3a3a3a] font-semibold text-[220%] text-left mb-2">Professores</h1>
            ...
            <div class="flex items-center gap-4 mb-6 justify-between">
                <div>
                    <div
                        ...
                        <span class="w-full block text-[80%]">Total Professores: 1</span>
                    </div>
                    <button onclick="window.location.href='adicionar-professor.htm'"
                        ...
                        <span class="w-full block text-[80%]">Adicionar Professor</span>
                    </button>
                </div>
            ...
            <div class="bg-white rounded-lg shadow max-w-6xl mx-auto overflow-x-auto overflow-y-auto">
                ...
                <table class="w-full">
                    ...
                    <tbody id="corpo-tabela">
                        <tr class="bg-white">
                            <td class="px-2 py-1 border-b text-[100%] space-y-2 whitespace-nowrap">Elena
                            </td>
                            <td class="px-2 py-1 border-b text-[100%] space-y-2 text-center">História</td>
                            <td class="px-2 py-1 border-b text-[100%] space-y-2 text-center">elena.hist@devant.org.br
                            </td>
                            <td class="px-2 py-1 border-b text-[100%] space-y-2 text-center">obaianotemomolho</td>
                            <td class="px-2 py-1 border-b text-[100%] text-center space-y-2"><button
                                    onclick="abrirFoto()"
                            ...
                            <td class="px-2 py-1 border-b text-xs">
                                <div class="flex space-x-2 justify-end"
                                    onclick="window.location.href='alterar-professor.htm'">
        ...
        <div id="popup-foto" onclick="fecharFoto()"
            ...
            <img src="/assets/perfil.jpg" alt="Foto aluno" class="max-w-[80vh] max-h-[80vh] w-full rounded">
