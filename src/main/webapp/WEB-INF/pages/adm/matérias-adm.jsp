            ...
            <div class="flex items-center gap-4 mb-6 justify-between">
                <div>
                    <div
                        ...
                        <span class="w-full block text-[80%]">Total Disciplinas: 1</span>
                    </div>
                    <button onclick="window.location.href='adicionar-materia.htm'"
                        ...
                        <span class="w-full block text-[80%]">Adicionar Disciplina</span>
                    </button>
                </div>
                ...
                <table class="w-full">
                    ...
                    <tbody id="corpo-tabela">
                        <tr class="bg-white text-[120%]">
                            <td class="px-2 py-1 border-b text-[100%] space-y-2 whitespace-nowrap">História
                            </td>
                            <td class="px-2 py-1 border-b text-[100%] space-y-2 whitespace-nowrap">Prof. João
                                Silva
                            </td>
                            <td class="px-2 py-1 border-b text-xs">
                                <div class="flex space-x-2 justify-end"
                                    onclick="window.location.href='alterar-materia.html'">
