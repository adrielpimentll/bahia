...
<main class="flex justify-center mt-24 px-4">
    <div class="bg-white rounded-2xl shadow-xl p-12 flex justify-between items-center w-full max-w-3xl">
        <div class="space-y-4">
            <h1 class="text-xs font-bold text-[#619AD6] uppercase text-[200%] mb-[-10px]">Perfil</h1>
            <div>
                <h2 class="text-4xl font-semibold text-gray-900">João Gomes da Silva</h2>
                <p class="text-gray-400 font-semibold text-lg">Aluno do 8° E.F. J</p>
            </div>

            <div class="space-y-2">
                <div>
                    <p class="text-gray-500 font-medium text-sm">Matrícula:</p>
                    <p class="text-gray-800">1zz</p>
                </div>
                <div>
                    <p class="text-gray-500 font-medium text-sm">Email:</p>
                    <p class="text-gray-800">Joao.gomes@devant.org.br</p>
                </div>
            </div>
        </div>
